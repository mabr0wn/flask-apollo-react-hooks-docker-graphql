...
const Blogs = () => { 
    ...
    const blogsData = [
    	...
    	{ 
          ...
          text:  `redux-form primarily consists of three things: 
    	...
    	{ 
          id: 3, 
          title: 'Redux', 
          text: `Redux is a predictable state container for 
        ...
        { 
          id: 4, 
          title: 'GraphQL', 
          text: `GraphQL is an open-source data query and manipulation 
